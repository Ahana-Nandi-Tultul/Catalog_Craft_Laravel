...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased" style = "background-color: #00264d;">
        <div>
        ...
        <footer class="bg-dark text-light mt-5 p-4">
                     <div class="container">
                    <h5 class="text-center">&copy; 2023 Catalog Craft || All rights reserved.</h5>
